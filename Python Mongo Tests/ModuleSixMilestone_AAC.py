...
app.layout = html.Div([
    ...
    html.Center(html.H3('Database of Animals')),
    ...
    html.Button('Delete Row', id='delete-row-btn', n_clicks=0),
...
#    State('my-table', 'columns')],
#)
#def del_row(n_clicks, rows, columns):
#    if n_clicks > 0:
#        rows.delete_many({c['id']: '' for c in columns})
#    return rows
...
def add_graphs(data):
    ...
    fig_hist2 = px.histogram(df_graph, 
                        x="date_of_birth",
